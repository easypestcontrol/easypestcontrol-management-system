      ...
      <div className="bg-white border border-[#e3e6ee] rounded-lg max-w-[820px] mx-auto shadow-sm">
        <div className="p-5 sm:p-10">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <span className="inline-block border-2 border-[#1B2E65] text-[#1B2E65] rounded px-3 py-1
          ...
          <div className="mt-4 flex items-end justify-between gap-x-4 gap-y-1 flex-wrap">
            <div>
              <div className="text-[17px] sm:text-[19px] font-bold tracking-[0.11em] text-[#1B2E65] leading-tight">
                SERVICE REPORT
              </div>
          ...
          <p className="text-[10.5px] text-gray-400 leading-relaxed mt-6">
            ...
            {x.reportSentAt ? ` on ${fmtD(x.reportSentAt.slice(0, 10))}` : ''}. Chemicals applied by
            licensed applicators as per CIB&amp;RC guidelines.
          </p>
        </div>
      </div>
